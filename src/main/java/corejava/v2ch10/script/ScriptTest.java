      ...
      EventQueue.invokeLater(new Runnable()
         {
            public void run()
            {
               try
               {
                  ...
                  final String frameClassName = args.length < 2 ? "corejava.v2ch10.buttons1.ButtonFrame" : args[1];


                  //JFrame frame = (JFrame) Class.forName(frameClassName).newInstance();
                  JFrame frame = new corejava.v2ch10.buttons1.ButtonFrame();
...
//                  getComponentBindings(frame, engine);
                  ...
                  System.out.println(frame.getClass().getResource(""));
                  //System.out.println(frame.getClass().getResource("/"));
                  ...
                  for (final Object e : events.keySet())
                  {
                     ...
                     Stream.of(s).forEach(n -> System.out.print(n + " : "));
