...
public class ShortestBridge {
    ...
    public static void main(String[] args) {
        ...
        int[][] a2 = new int[][]{{0,1,0},{0,0,0},{0,0,1}};
        int[][] a3 = new int[][]{{1,1,1,1,1},{1,0,0,0,1},{1,0,1,0,1}};
        System.out.println(shortestBridge.shortestBridge(a1));
        System.out.println(shortestBridge.shortestBridge(a2));
        System.out.println(shortestBridge.shortestBridge(a3));
    }
}
